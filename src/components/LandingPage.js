...
class LandingPage extends Component {
  render() {
    return (
      <div>
        <Grid style={{padding: '2rem 0 0 0', height: '100vh', background: 'linear-gradient(#eb0000, #ff5633)', display:'flex', justifyContent:'center'}}>
          <GridCell span='12' style={{ textAlign:'center', maxHeight:'500px', padding:'40% 10% 40% 10%', color:'rgba(255,255,255,.93)'}}><Typography use="headline2" style={{color: 'white'}}>KinePOP</Typography><br/><br/><Icon strategy="ligature" use="event_seat" style={{fontSize: '48px'}}/><br/><br/><Typography use="headline5">The movie search engine with the best recommendation algorithm in the world*.</Typography><br/><br/><br/><Typography use="body1" className='adv'>*Recommendation algorithm not included.</Typography></GridCell>
        </Grid>
        <Grid >
          <GridCell span='12' style={{padding: '5% 10% 1.5% 10%', textAlign:'center', color:'rgba(0,0,0,.75)'}}>
            <Typography use="headline5">I had a problem. <br/><br/>Whenever girlfriend and I were looking for a movie to watch, we would spend ages trying to find the right movie. <br/><br/>Well, I'll admit it: it was my fault. <br/><br/>I would usually open different websites. I wanted to scan movie posters quickly, examine actors/directors filmographies at light speed, and get a general feeling about the rating. <br/><br/>This is why I created KinePOP.</Typography>
          </GridCell>
