      ...
      <div className='LandingPage'>
        ...
        <LazyLoad height={600}><div className='LandingPage__second pinkback'>
            <div className='LandingPage__second__discover'>
              ...
              <div className="phone">
                ...
                <div className="vup ext"></div>
                <div className="vdown ext"></div>
                <div className="power ext">
        ...
        <LazyLoad height={600}><div className='LandingPage__second'>
            <div className='LandingPage__second__discover'>
              ...
              <div className='LandingPage__second__discover__text'>I like the guy in this movie, show me more!</div>
            </div>
        </div></LazyLoad>
        <footer>
